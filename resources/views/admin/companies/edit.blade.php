    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.companies.update", [$company->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('open_hours') ? 'is-invalid' : '' }}" name="open_hours" id="open_hours">{!! old('open_hours', $company->open_hours) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('city') ? 'is-invalid' : '' }}" name="city_id" id="city_id">
                    @foreach($cities as $id => $city)
                        <option value="{{ $id }}" {{ (old('city_id') ? old('city_id') : $company->city->id ?? '') == $id ? 'selected' : '' }}>{{ $city }}</option>
                    @endforeach
                </select>
                @if($errors->has('city'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('country') ? 'is-invalid' : '' }}" name="country_id" id="country_id">
                    @foreach($countries as $id => $country)
                        <option value="{{ $id }}" {{ (old('country_id') ? old('country_id') : $company->country->id ?? '') == $id ? 'selected' : '' }}>{{ $country }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('support_email_1') ? 'is-invalid' : '' }}" type="email" name="support_email_1" id="support_email_1" value="{{ old('support_email_1', $company->support_email_1) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('support_email_2') ? 'is-invalid' : '' }}" type="email" name="support_email_2" id="support_email_2" value="{{ old('support_email_2', $company->support_email_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('support_phone_1') ? 'is-invalid' : '' }}" type="number" name="support_phone_1" id="support_phone_1" value="{{ old('support_phone_1', $company->support_phone_1) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('support_phone_2') ? 'is-invalid' : '' }}" type="number" name="support_phone_2" id="support_phone_2" value="{{ old('support_phone_2', $company->support_phone_2) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('address_line') ? 'is-invalid' : '' }}" type="text" name="address_line" id="address_line" value="{{ old('address_line', $company->address_line) }}">
